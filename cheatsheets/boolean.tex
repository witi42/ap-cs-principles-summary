...
\lstdefinestyle{mystyle}{
    ...
    numberstyle=\small,   % Style of the numbers
    stepnumber=1,         % Number every line (you can change this to number every n-th line)
    numbersep=5pt,        % Distance between line numbers and the code
...
\section*{Variables CSP 3.1}

\subsection*{Variable Declaration}

You can think of a variables as a box with a label on it. We can look what value is in the box or we can put a new value in the box.

\begin{lstlisting}
    x $\leftarrow$ 5
\end{lstlisting}

This declares a variable x and assigns it the value 5.

We can increase the value of x by 1 like this:
\begin{lstlisting}
    x $\leftarrow$ x + 1
\end{lstlisting}

We can also work with several variables at once.
...
This will set z to 15.

\section*{Boolean Expressions CSP 3.5}
